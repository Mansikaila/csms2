...
{   
     ...
     public function pageSearch()
    {
        ...
        $sql="CAll \".$database_name.\"_search('t.city_name, t2.state_name as val2, t.country_id, t.city_id','tbl_city_master t INNER JOIN tbl_state_master t2 ON t.state_id=t2.state_id')";
        echo "
