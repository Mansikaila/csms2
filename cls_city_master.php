...
public function fetchCountry() {
    ...
    // Prepare static column and table names
    ...
    $whereCondition = "s.state_id = :state_id"; // Use placeholder here if your SP supports it
    ...
    // Replace the :state_id in the where condition with the actual value
    $whereCondition = "s.state_id = $state_id"; // If your SP can't accept bindings inside whereCondition
