...
{   
     ...
     public function pageSearch()
    {
        ...
        $sql="CAll ".$database_name."_search('t.city_name, t2.state_name as val2, t3.country_name, t.city_id, t4.person_name as modified_by, t.modified_date','tbl_city_master t LEFT JOIN tbl_state_master t2 ON t.state_id=t2.state_id LEFT JOIN tbl_country_master t3 ON t.country_id=t3.country_id LEFT JOIN tbl_user_master t4 ON t.modified_by=t4.user_id')";
        echo "
        ...
        <td> 
            ...
            <input type=\"hidden\" name=\"transactionmode\" value=\"D\"  />
                            ...
                            $_grid.= "<td> ".ucwords($fieldvalue)." </td>";
