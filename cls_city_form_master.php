...
class FormGenerator {
    ...
    public function __construct($tableName, $model = null) {
        ...
        $this->_mdl = $model;
         $this->formHtml = "<form id='popupForm'><div class='container-fluid'>";
        ...
        success: function (response) {
            try {
                ...
                if (data && data.country_id) {
                    $('#popupForm #country_id').val(data.country_id);
                    $('#popupForm #country_name').val(data.country_name);
                } else {
                    $('#popupForm #country_id').val('');
                    $('#popupForm #country_name').val('');
