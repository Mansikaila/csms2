...
{   
     ...
     public function pageSearch()
    {
        ...
        $sql="CAll csms1_search('t.start_date, t.end_date, t.modified_date, u2.person_name as modified_by, t.company_year_id','tbl_company_year_master t LEFT JOIN tbl_user_master u2  ON t.modified_by=u2.user_id ')";
        echo "
        ...
        <thead>
            ...
            <th> Start Date <br><input type=\"text\" data-index=\"3\" placeholder=\"Search Start Date\" /></th> 
                         ...
                         <th> Modified Date <br><input type=\"text\" data-index=\"7\" placeholder=\"Search Modified Date\" /></th> 
                         <th> Modified By <br><input type=\"text\" data-index=\"8\" placeholder=\"Search Modified By\" /></th> 
                         </tr>
        </thead>
        <tbody>";
         $_grid="";
