                    ...
                    if($generator_options) {
                        ...
                        if ($fields_types[$i] == "select") {
                            ...
                            if (!empty($dropdown_table[$i]) && !empty($label_column[$i]) && !empty($value_column[$i])) {
                                // Customer Active Condition
                                if ($fields_names[$i] == "customer_id") {
                                    $field_str .= getDropdown(
                                        $dropdown_table[$i],
                                        $value_column[$i],
                                        $label_column[$i],
                                        "`status` = '1'", // Filter only active customers
                                        $fields_names[$i],
                                        $selected_val,
                                        $cls,
                                        $required_str
                                ...
                                // Broker Active Condition
                                elseif ($fields_names[$i] == "broker_id") {
                                    $field_str .= getDropdown(
                                        $dropdown_table[$i],
                                        $value_column[$i],
                                        $label_column[$i],
                                        "`status` = '1'", // Filter only active brokers
                                        $fields_names[$i],
                                        $selected_val,
                                        $cls,
                                        $required_str
                                    ...
                                    $field_str .= '<option value="">No active entries</option>';
