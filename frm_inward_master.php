                                    ...
                                    case "select":
                                        ...
                                        if($fields_types[$i]=="checkbox" || $fields_types[$i]=="radio") {
                                         ...
                                         if($fields_types[$i]=="select") {
                                            ...
                                            } else if($fields_names[$i] == "customer_id") {
                                                $where_condition_val = "status = 1 AND customer_type = 'customer'";
                                            } else if($fields_names[$i] == "broker_id") {
                                                $where_condition_val = "status = 1 AND customer_type = 'broker'";
                                            } else {
