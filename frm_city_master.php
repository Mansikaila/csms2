                        ...
                        if(is_array($fields_names) && !empty($fields_names)) {
                            for($i=0;$i<count($fields_names);$i++) {
                                $required="";$checked="";$field_str="";$lbl_str="";$required_str="";$min_str="";$step_str="";$error_container="";$duplicate_str="";
                                 $cls_field_name="_".$fields_names[$i];$is_disabled=0;$disabled_str="";$add_modal_cls="";
                                ...
                                <?php
                                    ...
                                    if($field_str) {
                                    ?>
                                    <div class="<?php echo $field_layout_classes." ".$cls_err." ".$add_modal_cls; ?>"  >
                                    <?php
                                            echo $field_str;
                                            echo $lbl_err;
                                    ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- Add your state form here -->
                    <div class="mb-3">
                    <label for="new_state_name" class="form-label">State Name</label>
                    <input type="text" class="form-control" id="new_state_name" placeholder="Enter state name">
                    </div>
                </div>
