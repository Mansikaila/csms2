                                        ...
                                        if($fields_names[$i]!="modified_by" && $fields_names[$i]!="modified_date") {
                                            if($fields_names[$i]=="company_id") {
                                                if(isset($_SESSION["sess_company_id"])) {
                                                    $hiddenvalue=$_SESSION["sess_company_id"];
                                                } else {
                                                    $hiddenvalue=1;
                                                }
                                            }
                                            ...
                                            if($fields_names[$i]=="country_id") {
                                                $lbl_str='<label for="country_name" class="col-4 col-sm-2 col-md-1 col-lg-1 control-label">Country</label>';
                                                 $field_str.='<input type="text" class="form-control" id="country_name" name="country_name" disabled />
                                            ';
                                            }
                                        }
                                        break;
              ...
              <div class="box-footer">
               <?php echo  $hidden_str; ?>
                ...
                <input type="button" class="btn btn-dark" id="btn_cancel" name="btn_cancel" value="Cancel"  onclick="window.location=window.history.back();">
                  <input type="hidden" id="country_name_hidden" name="country_name" value="" />
              </div>
              <!-- /.box-footer -->
        </form>
        <!-- form end -->
        ...
        success: function (response) {
            try {
                ...
                if (data && data.country_id) {
                    ...
                    $('#country_name_hidden').val(data.country_name); // Hidden input ma set karo
                } else {
